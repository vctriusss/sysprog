...
void MealyFSM(int input, int X) {
    ...
    switch (globalState.mealy_curent_state) {
        ...
        case MealyS7:
            ...
            else if (10 == input)               {next_state = MealyS0; globalState.sell = 1; globalState.refund = 17 - X; doRefund();next_state=MealyS0;}
            break;
        ...
        case MealyS8:
            ...
            else if (10 == input)               {next_state = MealyS1; globalState.sell = 1; globalState.refund = 18 - X; doRefund();next_state=MealyS0;}
            break;
        case MealyS9:
            if      (1 == input)                next_state = MealyS10;
            else if (2 == input)                next_state = MealyS11;
            else if (5 == input)                next_state = MealyS14;
            else if (10 == input)               {next_state = MealyS2; globalState.sell = 1; globalState.refund = 19 - X; doRefund();next_state=MealyS0;}
            break;
        case MealyS10:
            if      (1 == input)                next_state = MealyS11;
            else if (2 == input)                next_state = MealyS12;
            else if (5 == input)                next_state = MealyS15;
            else if (10 == input)               {next_state = MealyS3; globalState.sell = 1; globalState.refund = 20 - X; doRefund();next_state=MealyS0;}
            break;
        case MealyS11:
            if      (1 == input)                next_state = MealyS12;
            else if (2 == input)                next_state = MealyS13;
            else if (5 == input)                next_state = MealyS16;
            else if (10 == input)               {next_state = MealyS4; globalState.sell = 1; globalState.refund = 21 - X; doRefund();next_state=MealyS0;}
            break;
        case MealyS12:
            if      (1 == input)                next_state = MealyS13;
            else if (2 == input)                next_state = MealyS14;
            else if (5 == input)                {next_state = MealyS0; globalState.sell = 1; globalState.refund = 17 - X; doRefund();next_state=MealyS0;}
            else if (10 == input)               {next_state = MealyS5; globalState.sell = 1; globalState.refund = 22 - X; doRefund();next_state=MealyS0;}
            break;
        case MealyS13:
            if      (1 == input)                next_state = MealyS14;
            else if (2 == input)                next_state = MealyS15;
            else if (5 == input)                {next_state = MealyS1; globalState.sell = 1; globalState.refund = 18 - X; doRefund();next_state=MealyS0;}
            else if (10 == input)               {next_state = MealyS6; globalState.sell = 1; globalState.refund = 23 - X; doRefund();next_state=MealyS0;}
            break;
        case MealyS14:
            if      (1 == input)                next_state = MealyS15;
            else if (2 == input)                next_state = MealyS16;
            else if (5 == input)                {next_state = MealyS2; globalState.sell = 1; globalState.refund = 19 - X; doRefund();next_state=MealyS0;}
            else if (10 == input)               {next_state = MealyS7; globalState.sell = 1; globalState.refund = 24 - X; doRefund();next_state=MealyS0;}
            break;
        case MealyS15:
            if      (1 == input)                next_state = MealyS16;
            else if (2 == input)                {next_state = MealyS0; globalState.sell = 1; globalState.refund = 17 - X; doRefund();next_state=MealyS0;}
            else if (5 == input)                {next_state = MealyS3; globalState.sell = 1; globalState.refund = 20 - X; doRefund();next_state=MealyS0;}
            else if (10 == input)               {next_state = MealyS8; globalState.sell = 1; globalState.refund = 25 - X; doRefund();next_state=MealyS0;}
            break;
        case MealyS16:
            if      (1 == input)                {next_state = MealyS0; globalState.sell = 1; globalState.refund = 17 - X; doRefund();next_state=MealyS0;}
            else if (2 == input)                {next_state = MealyS1; globalState.sell = 1; globalState.refund = 18 - X; doRefund();next_state=MealyS0;}
            else if (5 == input)                {next_state = MealyS4; globalState.sell = 1; globalState.refund = 21 - X; doRefund();next_state=MealyS0;}
            else if (10 == input)               {next_state = MealyS9; globalState.sell = 1; globalState.refund = 26 - X; doRefund();next_state=MealyS0;}
            break;
    }
    } else if (X == 16) {
        switch (globalState.mealy_curent_state) {
        ...
        case MealyS6:
            ...
            else if (10 == input)               {next_state = MealyS0; globalState.sell = 1; globalState.refund = 16 - X; doRefund();next_state=MealyS0;}
            break;
        ...
        case MealyS11:
            ...
            else if (5 == input)                {next_state = MealyS0; globalState.sell = 1; globalState.refund = 16 - X; doRefund();next_state=MealyS0;}
            else if (10 == input)               {next_state = MealyS4; globalState.sell = 1; globalState.refund = 21 - X; doRefund();next_state=MealyS0;}
            break;
        case MealyS12:
            if      (1 == input)                next_state = MealyS13;
        ...
        case MealyS14:
            if      (1 == input)                next_state = MealyS15;
            else if (2 == input)                {next_state = MealyS0; globalState.sell = 1; globalState.refund = 16 - X; doRefund();next_state=MealyS0;}
            else if (5 == input)                {next_state = MealyS2; globalState.sell = 1; globalState.refund = 19 - X; doRefund();next_state=MealyS0;}
            else if (10 == input)               {next_state = MealyS7; globalState.sell = 1; globalState.refund = 24 - X; doRefund();next_state=MealyS0;}
            break;
        case MealyS15:
...
void MooreFSM(int input, int X) {
    ...
    if (X == 17) {
        ...
        switch (globalState.moore_curent_state) {
            ...
            case MooreS18: globalState.sell = 1; globalState.refund = 18 - X; doRefund();next_state=MooreS0; break;
            case MooreS19: globalState.sell = 1; globalState.refund = 19 - X; doRefund();next_state=MooreS0; break;
            case MooreS20: globalState.sell = 1; globalState.refund = 20 - X; doRefund();next_state=MooreS0; break;
            case MooreS21: globalState.sell = 1; globalState.refund = 21 - X; doRefund();next_state=MooreS0; break;
            case MooreS22: globalState.sell = 1; globalState.refund = 22 - X; doRefund();next_state=MooreS0; break;
            case MooreS23: globalState.sell = 1; globalState.refund = 23 - X; doRefund();next_state=MooreS0; break;
            case MooreS24: globalState.sell = 1; globalState.refund = 24 - X; doRefund();next_state=MooreS0; break;
            case MooreS25: globalState.sell = 1; globalState.refund = 25 - X; doRefund();next_state=MooreS0; break;
            case MooreS26: globalState.sell = 1; globalState.refund = 26 - X; doRefund();next_state=MooreS0; break;
        }
    } else if (X == 16) {
        switch (globalState.moore_curent_state) {
        case MooreS0:
    ...
    switch (globalState.moore_curent_state) {
        case MooreS16: globalState.sell = 1; globalState.refund = 16 - X; doRefund();next_state=MooreS0; break;
        case MooreS17: globalState.sell = 1; globalState.refund = 17 - X; doRefund();next_state=MooreS0; break;
        case MooreS18: globalState.sell = 1; globalState.refund = 18 - X; doRefund();next_state=MooreS0; break;
        case MooreS19: globalState.sell = 1; globalState.refund = 19 - X; doRefund();next_state=MooreS0; break;
        case MooreS20: globalState.sell = 1; globalState.refund = 20 - X; doRefund();next_state=MooreS0; break;
...
int main() {
    ...
    printf("Choose one of goods: %d or %d: ", X1, X2);
    scanf("%d\n", &X);
